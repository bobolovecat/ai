...
Point.prototype = (function(o) {
    ...
    dragging:    false,
    _latestDrag: new Vector().set(0, 0),
...
(function() {
    ...
    window.mouse  = [new Vector(), new Vector()];
    ...
    window.loop = function() {
        console.log('showLightning', showLightning);
        if (showLightning) {
            context.save();
            ...
            lightning.startPoint.set(mouse[1].x, mouse[1].y);
            lightning.endPoint.set(mouse[0].x, mouse[0].y);
            console.log(mouse)
